      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="group relative p-6 bg-card rounded-lg border border-border hover:border-primary hover:shadow-lg hover:shadow-primary/20 transition-all duration-500 hover:scale-105 animate-slide-up"
              style={{ animationDelay: `${200 + index * 100}ms` }}
            >
              <div className="flex items-start gap-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-primary/20 text-primary shrink-0 group-hover:bg-primary/30 group-hover:scale-110 transition-all duration-300">
        ...
        {/* CTA */}
        <div className="mt-12 text-center animate-slide-up [animation-delay:800ms]">
          <Button variant="outline" size="lg" asChild className="border-primary/50 hover:bg-primary/10 bg-transparent group">
            <Link href="/services" className="text-primary font-semibold group-hover:text-primary/80 transition-colors">
              View All Services
